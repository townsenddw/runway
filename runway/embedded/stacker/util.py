...
class SourceProcessor(object):
    ...
    def update_paths_and_config(self, config, pkg_dir_name,
        ...
        Args:
            ...
            pkg_cache_path (string): fully qualified path to stacker cache
                                     cache directory

        """
        if pkg_cache_path is None:
            pkg_cache_path = self.package_cache_dir
        cached_dir_path = os.path.join(pkg_cache_path, pkg_dir_name)
